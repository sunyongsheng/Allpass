...
class Config {
  ...
  static void initConfig() {
    ...
    webDavUploadTime = Application.sp.getString(SPKeys.webDavUploadTime);
    webDavDownloadTime = Application.sp.getString(SPKeys.webDavDownloadTime);
    // 定期输入主密码天数
  ...
  static void setWebDavUploadTime(String value) {
    ...
    Application.sp.setString(SPKeys.webDavUploadTime, value);
  }

  static void setWebDavDownloadTime(String value) {
    webDavDownloadTime = value;
    Application.sp.setString(SPKeys.webDavDownloadTime, value);
  }
